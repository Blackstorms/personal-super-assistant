...
except ModuleNotFoundError:  # pragma: no cover - vendored tree may lag upstream
    import threading
    from contextlib import contextmanager

    class _StubReplacementCoordinator:
        ...
        def dispose(self, lease) -> None:
            return None

    replacement_coordinator = _StubReplacementCoordinator()
